...
from .views import (
    AuthRetrieveTransferredOperationFileView,
    AuthRetrieveTransferredOperationImageView,
    OperationViewSet,
    TransferredOperationCreateListView,
    TransferredOperationDestoryView,
    TransferredOperationFileDeleteView,
    TransferredOperationImageDeleteView,
)
