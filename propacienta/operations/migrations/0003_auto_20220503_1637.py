    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default="",
                max_length=250,
                verbose_name="Место проведения операции",
            ),
        ),
        migrations.AlterField(
            ...
            name="effect",
            field=models.CharField(
                blank=True, default="", max_length=250, verbose_name="Эффект"
            ),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=operations.utils.transferred_operation_images_dir,
                        verbose_name="Фото",
                    ),
                ),
                (
                    "transferred_operation",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="transferred_operation_images",
                        to="operations.transferredoperation",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        null=True,
                        upload_to=operations.utils.transferred_operation_files_dir,
                        verbose_name="Файл",
                    ),
                ),
                (
