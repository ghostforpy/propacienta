<template>
  <v-expansion-panel>
    ...
    <v-expansion-panel-content class="break-word"
      ...
      {{ computed_stamp_treatment_end_date }} <br />
      <div v-if="discharge_epicris != null">
        Выписной эпикриз: {{ cEpicris }}
      </div>
      <div v-if="discharge_epicris != null">
        Дата выписного эпикриза: {{ computedEpicrisStamp }}
      </div>
...
export default {
  ...
  props: {
    ...
    discharge_epicris: Object,
  },
  data: function () {
    return {
      imgs:
        this.discharge_epicris != null
          ? this.discharge_epicris.discharge_epicrisis_images
          : [],
      fils:
        this.discharge_epicris != null
          ? this.discharge_epicris.discharge_epicrisis_files
          : [],
    };
  },
  computed: {
    cEpicris: function () {
      return this.discharge_epicris.epicris;
    },
